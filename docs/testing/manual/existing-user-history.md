...
## Prerequisites
This test assumes that the database already contains a user profile (e.g. `alice@test.com` with password `password123` created in **[Manual Test: Fresh User Onboarding](fresh-user-onboarding.md)**).
